...
public class Rectangle extends TwoPointFigure implements GPrimitive{
	Rectangle(){}
	...
	public Rectangle Copy() {
		Rectangle r = new Rectangle(x1, y1, x2, y2, col);
		return r;
	}
	
	@Override
	public String toString() {
		return MessageFormat.format("Rectangle(x1={0}, y1={1}, x2={2}, y2={3}, Colour=[{4},{5},{6}])", 
